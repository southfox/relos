...
final class Item {
    ...
    init(timestamp: Date = Date().addingTimeInterval(60).truncatedToMinute, name: String = "", sound: String = soundDefault, volume: Double = Item.volumeDefault, isEnabled: Bool = true, isSnooze: Bool = true, snoozeDuration: Int = Item.snoozeDurationDefault) {
...
extension Item {
    ...
    static let soundDefault = "Default.mp3"
